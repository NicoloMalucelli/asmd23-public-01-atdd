...
public class LogicImpl implements Logic {
    ...
    public LogicImpl(int size, Pair<Integer, Integer> humanPosition, Pair<Integer, Integer> computerPosition) {
        this.size = size;
        this.positions.put(Player.HUMAN, humanPosition);
        this.positions.put(Player.COMPUTER, computerPosition);
    }
